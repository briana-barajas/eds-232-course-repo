...
autoplot(rf_cv_tune) + #plot cv results for parameter tuning
  theme_bw()
```
**NOTE:** For the predictors there's a noticable increase in AUC and accuracy as randomly selected predictors increase. There is not a notable pattern based on number of trees.
#### Finalize workflow
