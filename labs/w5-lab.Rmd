...
top_tracks_fun <- function(code){
  ...
  rbind(top_50, top_100, top_150, top_200, top_250, top_300, top_350,
        top_400, top_450, top_500)
...
audio_features_fun <- function(row_seq){
  ...
  rbind(top_100, top_200, top_300, top_400, top_500)
...
compare_track_audio <- rbind(my_tracks_audio, rosemary_tracks_audio) %>% 
  ...
  mutate(time_signiature = as.factor(time_signature),
