...
dt_tree_rs <- tune_grid(
    wf_dt_tune,
    resamples = dt_cv_folds,
    grid = tree_grid,
    metrics = metric_set(accuracy)) #END tune_grid

# select best hyperparameters
final_d_tree <- finalize_workflow(wf_dt_tune,
                                  select_best(dt_tree_rs))

## ==================================
##          DT Final Model       ----
## ==================================
final_dt_fit <- fit(final_d_tree, data = audio_train)

final_dt_result <- last_fit(final_dt_fit, audio_split)
```
...
# set up cv-folds
rf_cv_folds <- vfold_cv(audio_train, v = 5)
...
rf_cv_tune <- rf_workflow %>% 
  tune_grid(resamples = rf_cv_folds, grid = 10)


## ==================================
##      Random Forest Resamples  ----
## ==================================
